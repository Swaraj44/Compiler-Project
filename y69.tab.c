...
static const yytype_uint16 yyrline[] =
{
     ...
     125,   126,   127,   128,   129,   134,   135,   150,   151,   152,
     153,   156,   157,   174,   175,   176,   177,   180,   181,   184,
     185,   186,   192,   219,   220,   221,   225,   226,   227,   228,
     229,   230,   232,   240,   248,   256,   264,   271,   278,   285,
     292,   315,   338,   361,   384,   392,   419,   422,   425,   426,
     429,   432,   435,   436,   437,   438,   439,   440,   441,   442,
     443
};
#endif
...
int main(void)
{
    ...
    freopen("Input69.txt","r",stdin);
	freopen("output69.txt","w",stdout);
	yyparse();
    return 0;
